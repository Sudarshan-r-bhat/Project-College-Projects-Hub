    ...
    <div id="particles-js">
        <div id="login">
            <header>
                ...
                <div>
                    <div>
                    <p style="color:#8fa9ff;"><i class="fa fa-user-circle"></i>Hi <?php echo $_SESSION['username']; ?><sub>glad to see you here...</sub></p>
                        <nav id="header">
                        <ul>
                        <li> 
                    ...
                    <form action="search_driver.php" method = "post">
                        <div id="search">
                            ...
                            <div id="formSearch">
                                ...
                                <!-- i think this form is redundant here. -->
                                ...
                                <div>
                                    <?php
                                        ...
                                        { 
                                            ...
                                            {
                                                $html0 = '<form method="post" action="general_proj_description_driver.php">'.
                                                '<input type="hidden" name="general_title" value="'.$sr.'"><input style="background: transparent; color:#fff;" type="submit" value="click to visit"></form>';
                                                echo($html0.'<br>');
                                            }    
                                        }
